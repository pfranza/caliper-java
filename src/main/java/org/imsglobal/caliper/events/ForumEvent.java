...
@SupportedActions({ Action.SUBSCRIBED, Action.UNSUBSCRIBED })
public class ForumEvent extends Event {
	...
	/**
	 * Utilize builder to construct ForumEvent. Validate Forum object copy rather than the Forum builder. This approach
