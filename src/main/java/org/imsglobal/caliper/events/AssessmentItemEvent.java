...
@SupportedActions({ Action.STARTED, Action.COMPLETED, Action.SKIPPED })
public class AssessmentItemEvent extends Event {
	 ...
	 * AssessmentItem builder. This approach protects the class against parameter changes from another thread during the
	 * "window of vulnerability" between the time the parameters are checked until when they are copied.
	 *
	 * @param builder
	 */
