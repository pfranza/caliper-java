...
@SupportedActions({ Action.MARKED_AS_READ, Action.MARKED_AS_UNREAD })
public class ThreadEvent extends Event {
	...
	/**
	 * Utilize builder to construct ThreadEvent. Validate Thread object copy rather than the Thread builder. This
