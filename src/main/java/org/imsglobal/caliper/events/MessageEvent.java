...
@SupportedActions({ Action.MARKED_AS_READ, Action.MARKED_AS_UNREAD, Action.POSTED })
public class MessageEvent extends Event {
	...
	/**
	 * Utilize builder to construct MessageEvent. Validate Message object copy rather than the Message builder. This
	 * approach protects the class against parameter changes from another thread during the "window of vulnerability"
	 * between the time the parameters are checked until when they are copied.
	 *
	 * @param builder
	 */
